  ...
  <table class="min-w-full divide-y divide-gray-300">
    ...
    <tbody class="divide-y divide-gray-200">
      <tr v-for="expediente in expedientes" :key="expediente.id">
        <td class="py-4 pr-3 pl-4 text-sm whitespace-nowrap text-gray-700 sm:pl-0">
        ...
        <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-700">
          {{ expediente.responsables[0].nombre }}
        </td>
        <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-700">
          {{ expediente.direccion }}
        </td>
        <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-700">
          {{ expediente.responsables[0].telefono }}
        </td>
